...
# Selector de fecha inicio y fecha final por separado
...
# Selector múltiple de ingredientes sin selección por defecto (usa session_state)
...
# 4. Filtrado de datos por solapamiento de rangos
# Incluye registros cuya fecha_inicio <= end_ts y fecha_final >= start_ts
df_filtrado = df[
...
# 6. Cálculo de métricas y unidad
...
# 8. Tabla de detalle autoajustable
